...
arch=$(uname -m)
if [[ "$arch" == "x86_64" ]]; then
    ipfsdistr="https://github.com/ipfs/kubo/releases/download/v0.40.1/kubo_v0.40.1_linux-amd64.tar.gz"
    yggdistr="https://github.com/yggdrasil-network/yggdrasil-go/releases/download/v0.5.12/yggdrasil-0.5.12-amd64.deb"
elif [[ "$arch" == "aarch64" ]]; then
    ipfsdistr="https://github.com/ipfs/kubo/releases/download/v0.40.1/kubo_v0.40.1_linux-arm64.tar.gz"
    yggdistr="https://github.com/yggdrasil-network/yggdrasil-go/releases/download/v0.5.12/yggdrasil-0.5.12-arm64.deb"
elif [[ "$arch" == "riscv64" ]]; then
    ipfsdistr="https://github.com/ipfs/kubo/releases/download/v0.40.1/kubo_v0.40.1_linux-riscv64.tar.gz"
